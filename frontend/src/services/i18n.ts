...
const resources = {
  en: {
    translation: {
      ...
      'auth.phoneEmailPlaceholder': 'Enter your phone number or email',
      'auth.phoneEmailRequired': 'Phone number or email is required',
      'auth.email': 'Email',
      ...
      'language.detectedMessage': 'Based on your location ({location}), we\'ve set your language to:',
      'language.changeAnytime': 'You can change this anytime using the language selector',
  ...
  hi: {
    translation: {
      ...
      'auth.phoneOrEmail': 'फोन नंबर या ईमेल',
      'auth.phoneEmailPlaceholder': 'अपना फोन नंबर या ईमेल दर्ज करें',
      'auth.phoneEmailRequired': 'फोन नंबर या ईमेल आवश्यक है',
      'auth.email': 'ईमेल',
      'auth.phone': 'फोन नंबर',
      ...
      'auth.demoAccount': 'डेमो खाता:',
      'auth.useDemoAccount': 'डेमो खाता उपयोग करें',
      ...
      'language.detected': 'भाषा का पता चला',
      'language.detectedMessage': 'आपके स्थान ({location}) के आधार पर, हमने आपकी भाषा सेट कर दी है:',
      'language.changeAnytime': 'आप भाषा चयनकर्ता का उपयोग करके इसे कभी भी बदल सकते हैं',
  ...
  ml: {
    translation: {
      ...
      'auth.signIn': 'സൈൻ ഇൻ',
      'auth.signInToAccount': 'നിങ്ങളുടെ അക്കൗണ്ടിലേക്ക് സൈൻ ഇൻ ചെയ്യുക',
      'auth.signingIn': 'സൈൻ ഇൻ ചെയ്യുന്നു...',
      'auth.or': 'അല്ലെങ്കിൽ',
      'auth.createNewAccount': 'പുതിയ അക്കൗണ്ട് സൃഷ്ടിക്കുക',
      'auth.phoneOrEmail': 'ഫോൺ നമ്പർ അല്ലെങ്കിൽ ഇമെയിൽ',
      'auth.phoneEmailPlaceholder': 'നിങ്ങളുടെ ഫോൺ നമ്പർ അല്ലെങ്കിൽ ഇമെയിൽ നൽകുക',
      'auth.phoneEmailRequired': 'ഫോൺ നമ്പർ അല്ലെങ്കിൽ ഇമെയിൽ ആവശ്യമാണ്',
      'auth.email': 'ഇമെയിൽ',
      'auth.phone': 'ഫോൺ നമ്പർ',
      'auth.password': 'പാസ്‌വേഡ്',
      'auth.passwordPlaceholder': 'നിങ്ങളുടെ പാസ്‌വേഡ് നൽകുക',
      'auth.passwordRequired': 'പാസ്‌വേഡ് ആവശ്യമാണ്',
      ...
      'auth.demoAccount': 'ഡെമോ അക്കൗണ്ട്:',
      'auth.useDemoAccount': 'ഡെമോ അക്കൗണ്ട് ഉപയോഗിക്കുക',
      ...
      'language.detected': 'ഭാഷ കണ്ടെത്തി',
      'language.detectedMessage': 'നിങ്ങളുടെ സ്ഥലം ({location}) അടിസ്ഥാനമാക്കി, ഞങ്ങൾ നിങ്ങളുടെ ഭാഷ സജ്ജമാക്കി:',
      'language.changeAnytime': 'ഭാഷാ സെലക്ടർ ഉപയോഗിച്ച് നിങ്ങൾക്ക് ഇത് എപ്പോൾ വേണമെങ്കിലും മാറ്റാം',
